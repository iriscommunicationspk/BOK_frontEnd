...
<template>
  <header class="sticky top-0 z-999 flex w-full bg-[#F4F5F7]">
    <div
      class="flex flex-grow items-center justify-between lg:justify-center py-4 px-4 md:px-6 2xl:px-11 bg-[#F4F5F7]"
    >
