...
//       enabled: false,
//       style: {
//         // colors: ['white', 'white'] // Text colors for data labels (adjust as needed)
//       },
//       background: {
//         enabled: true,
//         // foreColor: '#c6c6c6', // Color of text inside the background
//         borderRadius: 0,
//         dropShadow: {
//           enabled: false
//         }
...
//         shadeIntensity: 0.5,
//         gradientToColors: ['white', 'black'], // Corresponding gradient colors
//         inverseColors: true,
//         opacityFrom: 1,
//         opacityTo: 1,
//         stops: [0, 100]
//       }
//     },
//     colors: ['#a4b524', 'red'], // Base colors for each series
