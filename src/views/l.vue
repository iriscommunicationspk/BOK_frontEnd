<template>
  <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    <div class="mb-5 flex items-center justify-between">
      <div>
        <h2 class="mb-1.5 text-title-md2 font-bold text-black dark:text-white">Highlights</h2>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 2xl:gap-7.5">
      ...
      >
        <span
          ...
          >
            ...
            ></path></svg
        ></span>
        <h4 class="mt-5 mb-2 font-medium">Avg. Client Rating</h4>
        <h3 class="mb-2 text-title-md font-bold text-black dark:text-white">7.8/10</h3>
        <p class="flex items-center gap-1 text-sm font-medium">
          ...
          >
            <path
              ...
              fill="#10B981"
            ></path></svg
          ><!----><span class="text-meta-3">2.5%</span><span>than last Week</span>
        </p>
      </div>
      <div
        class="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5"
      >
        <span
          ...
          >
            ...
            ></path></svg
        ></span>
        <h4 class="mt-5 mb-2 font-medium">Instagram Followers</h4>
        <h3 class="mb-2 text-title-md font-bold text-black dark:text-white">7.8/10</h3>
        <p class="flex items-center gap-1 text-sm font-medium">
          <!----><svg
            width="14"
          ...
          >
            <path
              ...
              fill="#FB5454"
            ></path></svg
          ><span class="text-red">-1.5%</span><span>than last Week</span>
        </p>
      </div>
      <div
        class="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5"
      >
        ...
        ></span>
        <h4 class="mt-5 mb-2 font-medium">Avg. Client Rating</h4>
        <h3 class="mb-2 text-title-md font-bold text-black dark:text-white">$5.03</h3>
        <p class="flex items-center gap-1 text-sm font-medium">
          <svg
            width="14"
            height="14"
          ...
          >
            <path
              ...
              fill="#10B981"
            ></path></svg
          ><!----><span class="text-meta-3">2.6%</span><span>than last Week</span>
        </p>
      </div>
    </div>
    <div class="mt-7.5 grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
      <div class="col-span-12 xl:col-span-7">
        ...
        >
          <div class="mb-6 flex justify-between">
            <div>
              <h4 class="text-title-sm2 font-bold text-black dark:text-white">Top Channels</h4>
            </div>
            <div class="relative">
              <button>
                <svg
          ...
          <div class="flex flex-col">
            ...
            <div
              class="grid grid-cols-3 sm:grid-cols-4 border-b border-stroke dark:border-strokedark"
            >
            ...
            >
              <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="h-9 w-full max-w-9 flex-shrink-0">
                  <img
                    src="data:image/svg+xml,%3csvg%20width='48'%20height='48'%20viewBox='0%200%2048%2048'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3ccircle%20cx='24'%20cy='24.0001'%20r='24'%20fill='%232B96F0'/%3e%3cpath%20d='M33.0375%2017.7376L34.4625%2015.9376C34.875%2015.4501%2034.9875%2015.0751%2035.025%2014.8876C33.9%2015.5626%2032.85%2015.7876%2032.175%2015.7876H31.9125L31.7625%2015.6376C30.8625%2014.8501%2029.7375%2014.4376%2028.5375%2014.4376C25.9125%2014.4376%2023.85%2016.6126%2023.85%2019.1251C23.85%2019.2751%2023.85%2019.5001%2023.8875%2019.6501L24%2020.4001L23.2125%2020.3626C18.4125%2020.2126%2014.475%2016.0876%2013.8375%2015.3751C12.7875%2017.2501%2013.3875%2019.0501%2014.025%2020.1751L15.3%2022.2751L13.275%2021.1501C13.3125%2022.7251%2013.9125%2023.9626%2015.075%2024.8626L16.0875%2025.6126L15.075%2026.0251C15.7125%2027.9376%2017.1375%2028.7251%2018.1875%2029.0251L19.575%2029.4001L18.2625%2030.3001C16.1625%2031.8001%2013.5375%2031.6876%2012.375%2031.5751C14.7375%2033.2251%2017.55%2033.6001%2019.5%2033.6001C20.9625%2033.6001%2022.05%2033.4501%2022.3125%2033.3376C32.8125%2030.8626%2033.3%2021.4876%2033.3%2019.6126V19.3501L33.525%2019.2001C34.8%2018.0001%2035.325%2017.3626%2035.625%2016.9876C35.5125%2017.0251%2035.3625%2017.1001%2035.2125%2017.1376L33.0375%2017.7376Z'%20fill='white'/%3e%3c/svg%3e"
                    alt="Brand"
                  />
                </div>
            ...
            >
              <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="h-9 w-full max-w-9 flex-shrink-0">
                  <img
                    src="data:image/svg+xml,%3csvg%20width='36'%20height='36'%20viewBox='0%200%2036%2036'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3ccircle%20cx='18'%20cy='18'%20r='18'%20fill='%23FF0000'/%3e%3cpath%20d='M26.3531%2013.8094C26.1562%2013.05%2025.5656%2012.4594%2024.8063%2012.2625C23.4563%2011.8969%2018%2011.8969%2018%2011.8969C18%2011.8969%2012.5438%2011.8969%2011.1938%2012.2625C10.4344%2012.4594%209.84375%2013.05%209.64687%2013.8094C9.28125%2015.1875%209.28125%2018%209.28125%2018C9.28125%2018%209.28125%2020.8406%209.64687%2022.1906C9.84375%2022.95%2010.4344%2023.5406%2011.1938%2023.7375C12.5438%2024.1031%2018%2024.1031%2018%2024.1031C18%2024.1031%2023.4563%2024.1031%2024.8063%2023.7375C25.5656%2023.5406%2026.1562%2022.95%2026.3531%2022.1906C26.7188%2020.8406%2026.7188%2018%2026.7188%2018C26.7188%2018%2026.7188%2015.1875%2026.3531%2013.8094ZM16.2562%2020.6156V15.3844L20.7844%2018L16.2562%2020.6156Z'%20fill='white'/%3e%3c/svg%3e"
                    alt="Brand"
                  />
                </div>
                <p class="hidden font-medium text-black dark:text-white sm:block">Youtube</p>
              </div>
              <div class="flex items-center justify-center p-2.5 xl:p-5">
            ...
            >
              <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="h-9 w-full max-w-9 flex-shrink-0">
                  <img
                    src="data:image/svg+xml,%3csvg%20width='48'%20height='48'%20viewBox='0%200%2048%2048'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3ccircle%20cx='24'%20cy='24.0002'%20r='24'%20fill='%234DC1FF'/%3e%3cpath%20d='M35.625%2018.6002C35.5125%2020.8877%2033.9375%2024.0002%2030.8625%2027.9377C27.7125%2032.0627%2025.0125%2034.1252%2022.8375%2034.1252C21.525%2034.1252%2020.3625%2032.9252%2019.3875%2030.3752C18.75%2028.1252%2018.1875%2025.8002%2017.5125%2023.4752C16.8375%2021.0002%2016.0875%2019.7252%2015.225%2019.7252C15.075%2019.7252%2014.4375%2020.1002%2013.3875%2020.8502L12.375%2019.3502C13.5375%2018.3377%2014.6625%2017.3252%2015.825%2016.2752C17.3625%2014.9627%2018.45%2014.2502%2019.275%2014.2127C21.075%2014.0627%2022.1625%2015.3377%2022.6125%2017.9252C23.025%2020.7752%2023.3625%2022.5752%2023.55%2023.2502C24.075%2025.6127%2024.675%2026.7752%2025.2375%2026.7752C25.725%2026.7752%2026.4375%2026.0252%2027.45%2024.4877C28.4625%2022.9502%2028.9125%2021.7502%2029.025%2020.9627C29.175%2019.6502%2028.6125%2018.9377%2027.45%2018.9377C26.925%2018.9377%2026.325%2019.0502%2025.7625%2019.3502C26.8875%2015.6002%2029.025%2013.7627%2032.25%2013.8377C34.6125%2013.9502%2035.7375%2015.5252%2035.625%2018.6002Z'%20fill='white'/%3e%3c/svg%3e"
                    alt="Brand"
                  />
                </div>
            ...
            <div class="grid grid-cols-3 sm:grid-cols-4">
              <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="h-9 w-full max-w-9 flex-shrink-0">
                  <img
                    src="data:image/svg+xml,%3csvg%20width='48'%20height='48'%20viewBox='0%200%2048%2048'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3ccircle%20cx='24'%20cy='24.0002'%20r='24'%20fill='%233162C9'/%3e%3cg%20clip-path='url(%23clip0_38_23887)'%3e%3cpath%20d='M25.789%2035.9983V25.0533H29.3269L29.8566%2020.7878H25.789V18.0645C25.789%2016.8295%2026.1192%2015.9879%2027.8248%2015.9879L30%2015.9868V12.1719C29.6236%2012.1201%2028.3325%2012.004%2026.8304%2012.004C23.6942%2012.004%2021.5471%2013.9917%2021.5471%2017.6422V20.7879H18V25.0534H21.547V35.9984L25.789%2035.9983Z'%20fill='white'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_38_23887'%3e%3crect%20width='12'%20height='24'%20fill='white'%20transform='translate(18%2012.0002)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e"
                    alt="Brand"
                  />
                </div>
      ...
      >
        <div class="flex justify-between border-b border-stroke py-5 px-6 dark:border-strokedark">
          ...
          <div>
            <h3 class="mb-1.5 text-title-md2 font-bold text-black dark:text-white">784k</h3>
        ...
        <div class="py-7.5 px-6">
          <div id="chartFive" class="-ml-5">
            <div class="vue-apexcharts" style="min-height: 365px">
              <div
                id="apexcharts4w6rmshb"
                class="apexcharts-canvas apexcharts4w6rmshb apexcharts-theme-light"
              ...
              >
                ...
                >
                  <foreignObject x="0" y="0" width="559" height="350"
                    ><div
                  ...
                  >
                    <g id="SvgjsG1069" class="apexcharts-yaxis-texts-g">
                      <text
                        id="SvgjsText1071"
                      ...
                      >
                        <tspan id="SvgjsTspan1072">400</tspan>
                        <title>400</title>
                      </text>
                      <text
                        id="SvgjsText1074"
                        ...
                        style="font-family: Satoshi, sans-serif"
                      >
                        <tspan id="SvgjsTspan1075">300</tspan>
                        <title>300</title>
                      </text>
                      <text
                        id="SvgjsText1077"
                        ...
                        style="font-family: Satoshi, sans-serif"
                      >
                        <tspan id="SvgjsTspan1078">200</tspan>
                        <title>200</title>
                      </text>
                      <text
                        id="SvgjsText1080"
                        ...
                        style="font-family: Satoshi, sans-serif"
                      >
                        <tspan id="SvgjsTspan1081">100</tspan>
                        <title>100</title>
                      </text>
                      <text
                        id="SvgjsText1083"
                        ...
                        style="font-family: Satoshi, sans-serif"
                      >
                        <tspan id="SvgjsTspan1084">0</tspan>
                        <title>0</title>
                      </text>
                    </g>
                  </g>
                  ...
                  >
                    <defs id="SvgjsDefs1002">
                      <linearGradient id="SvgjsLinearGradient1006" x1="0" y1="0" x2="0" y2="1">
                        <stop
                          id="SvgjsStop1007"
                          stop-opacity="0.4"
                      ...
                      <clipPath id="gridRectMask4w6rmshb">
                        <rect
                          id="SvgjsRect1011"
                          width="511.640625"
                          height="302.348"
                      ...
                      <clipPath id="forecastMask4w6rmshb"></clipPath>
                      <clipPath id="nonForecastMask4w6rmshb"></clipPath>
                      <clipPath id="gridRectMarkerMask4w6rmshb">
                        <rect
                          id="SvgjsRect1012"
                          width="507.640625"
                          height="286.348"
                    ...
                    <rect
                      ...
                      fill-opacity="0.9"
                    ></rect>
                    <g id="SvgjsG1032" class="apexcharts-grid">
                      <g id="SvgjsG1033" class="apexcharts-gridlines-horizontal">
                        <line
                          id="SvgjsLine1037"
                          x1="0"
                          y1="70.587"
                        ...
                        <line
                          id="SvgjsLine1039"
                          x1="0"
                          y1="211.76100000000002"
                          x2="503.640625"
                          y2="211.76100000000002"
                          stroke="#e0e0e0"
                          stroke-dasharray="7"
                          stroke-linecap="butt"
                          class="apexcharts-gridline"
                      ...
                      <g id="SvgjsG1034" class="apexcharts-gridlines-vertical"></g>
                      <line
                        id="SvgjsLine1042"
                        x1="0"
                        y1="282.348"
                    ...
                    <g id="SvgjsG1035" class="apexcharts-grid-borders">
                      <line
                        id="SvgjsLine1036"
                        x1="0"
                        y1="0"
                    ...
                    <g id="SvgjsG1013" class="apexcharts-bar-series apexcharts-plot-series">
                      <g
                        id="SvgjsG1014"
                      ...
                      >
                        <path
                          id="SvgjsPath1019"
                          d="M26.98074776785714 282.349L26.98074776785714 163.76284L40.96791294642857 163.76284L40.96791294642857 282.349L26.98074776785714 282.349C26.98074776785714 282.349 26.98074776785714 282.349 26.98074776785714 282.349C26.98074776785714 282.349 26.98074776785714 282.349 26.98074776785714 282.349C26.98074776785714 282.349 26.98074776785714 282.349 26.98074776785714 282.349C26.98074776785714 282.349 26.98074776785714 282.349 26.98074776785714 282.349 "
                          ...
                          index="0"
                          clip-path="url(#gridRectMask4w6rmshb)"
                          pathTo="M 26.98074776785714 282.349 L 26.98074776785714 163.76284 L 40.96791294642857 163.76284 L 40.96791294642857 282.349 Z"
                          pathFrom="M 26.98074776785714 282.349 L 26.98074776785714 282.349 L 40.96791294642857 282.349 L 40.96791294642857 282.349 L 40.96791294642857 282.349 L 40.96791294642857 282.349 L 40.96791294642857 282.349 L 26.98074776785714 282.349 Z"
                          cy="163.76184"
                          cx="96.92940848214285"
                          j="0"
                          val="168"
                          barHeight="118.58616"
                          barWidth="17.987165178571427"
                        ></path>
                        <path
                          id="SvgjsPath1021"
                          d="M98.92940848214285 282.349L98.92940848214285 10.589049999999986L112.91657366071428 10.589049999999986L112.91657366071428 282.349L98.92940848214285 282.349C98.92940848214285 282.349 98.92940848214285 282.349 98.92940848214285 282.349C98.92940848214285 282.349 98.92940848214285 282.349 98.92940848214285 282.349C98.92940848214285 282.349 98.92940848214285 282.349 98.92940848214285 282.349C98.92940848214285 282.349 98.92940848214285 282.349 98.92940848214285 282.349 "
                          fill="rgba(60,80,224,1)"
                          fill-opacity="1"
                          stroke="transparent"
                          stroke-opacity="1"
                          ...
                          index="0"
                          clip-path="url(#gridRectMask4w6rmshb)"
                          pathTo="M 98.92940848214285 282.349 L 98.92940848214285 10.58905000000001 L 112.91657366071428 10.58905000000001 L 112.91657366071428 282.349 Z"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1049">M</tspan>
                          <title>M</title>
                        </text>
                        <text
                          id="SvgjsText1051"
                          font-family="Satoshi, sans-serif"
                          x="107.92299107142856"
                          y="311.348"
                          text-anchor="middle"
                          dominant-baseline="auto"
                          font-size="12px"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1052">T</tspan>
                          <title>T</title>
                        </text>
                        <text
                          id="SvgjsText1054"
                          font-family="Satoshi, sans-serif"
                          x="179.87165178571425"
                          y="311.348"
                          text-anchor="middle"
                          dominant-baseline="auto"
                          font-size="12px"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1055">W</tspan>
                          <title>W</title>
                        </text>
                        <text
                          id="SvgjsText1057"
                          font-family="Satoshi, sans-serif"
                          x="251.82031249999997"
                          y="311.348"
                          text-anchor="middle"
                          dominant-baseline="auto"
                          font-size="12px"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1058">T</tspan>
                          <title>T</title>
                        </text>
                        <text
                          id="SvgjsText1060"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1061">F</tspan>
                          <title>F</title>
                        </text>
                        <text
                          id="SvgjsText1063"
                          font-family="Satoshi, sans-serif"
                          x="395.71763392857144"
                          y="311.348"
                          text-anchor="middle"
                          dominant-baseline="auto"
                          font-size="12px"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1064">S</tspan>
                          <title>S</title>
                        </text>
                        <text
                          id="SvgjsText1066"
                          font-family="Satoshi, sans-serif"
                          x="467.66629464285717"
                          y="311.348"
                          text-anchor="middle"
                          dominant-baseline="auto"
                          font-size="12px"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1067">S</tspan>
                          <title>S</title>
                        </text>
                      </g>
                    </g>
                ...
                <div class="apexcharts-tooltip apexcharts-theme-light">
                  <div class="apexcharts-tooltip-series-group" style="order: 1">
                    <span
                      ...
                      style="background-color: rgb(60, 80, 224)"
                    ></span>
                    <div
                      class="apexcharts-tooltip-text"
                      style="font-family: Satoshi, sans-serif; font-size: 12px"
                    >
        ...
        <div class="px-3 pb-5">
          ...
          >
            ...
            <a
              aria-current="page"
              href="/dashboard/marketing#"
              class="router-link-active router-link-exact-active inline-block hover:text-primary"
              ><svg
                class="fill-current"
                width="16"
                height="16"
      ...
      <div class="col-span-12 xl:col-span-7">
        ...
        >
          <div class="mb-6 flex items-start justify-between">
            <div>
              <h4 class="text-title-sm2 font-bold text-black dark:text-white">Campaign Visitors</h4>
              <div class="mt-2.5 flex gap-2.5">
                <h3 class="mb-1.5 text-title-lg font-bold text-black dark:text-white">$560.93</h3>
          ...
          <div>
            <div id="chartSix" class="-ml-5">
              <div class="vue-apexcharts" style="min-height: 215px">
                <div
                  id="apexchartsraj9uvxh"
                  class="apexcharts-canvas apexchartsraj9uvxh apexcharts-theme-light"
                  style="width: 795px; height: 200px"
                >
                  <svg
                    id="SvgjsSvg1088"
                    width="795"
                    ...
                    style="background: transparent"
                  >
                    <foreignObject x="0" y="0" width="795" height="200"
                      ><div
                        class="apexcharts-legend"
                        xmlns="http://www.w3.org/1999/xhtml"
                    ...
                    <g
                      ...
                      transform="translate(15.359375, 0)"
                    >
                      <g id="SvgjsG1181" class="apexcharts-yaxis-texts-g">
                        <text
                          id="SvgjsText1183"
                          font-family="Satoshi, sans-serif"
                          x="20"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1184">350</tspan>
                          <title>350</title>
                        </text>
                        <text
                          id="SvgjsText1186"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1187">300</tspan>
                          <title>300</title>
                        </text>
                        <text
                          id="SvgjsText1189"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1190">250</tspan>
                          <title>250</title>
                        </text>
                        <text
                          id="SvgjsText1192"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1193">200</tspan>
                          <title>200</title>
                        </text>
                        <text
                          id="SvgjsText1195"
                          ...
                          style="font-family: Satoshi, sans-serif"
                        >
                          <tspan id="SvgjsTspan1196">150</tspan>
                          <title>150</title>
                        </text>
                        <text
                          id="SvgjsText1198"
                    ...
                    >
                      <defs id="SvgjsDefs1089">
                        <clipPath id="gridRectMaskraj9uvxh">
                          <rect
                            id="SvgjsRect1095"
                            width="733.3017578125"
                            height="144.348"
                            x="-4"
                            y="-6"
                            rx="0"
                        ...
                        <clipPath id="forecastMaskraj9uvxh"></clipPath>
                        <clipPath id="nonForecastMaskraj9uvxh"></clipPath>
                        <clipPath id="gridRectMarkerMaskraj9uvxh">
                          <rect
                            id="SvgjsRect1096"
                            width="731.3017578125"
                            height="136.348"
                            x="-2"
                            y="-2"
                            rx="0"
                        ...
                        <linearGradient id="SvgjsLinearGradient1101" x1="0" y1="0" x2="0" y2="1">
                          <stop
                            id="SvgjsStop1102"
                            stop-opacity="0.55"
                            stop-color="rgba(19,194,150,0.55)"
                            offset="0"
                          ></stop>
                          <stop
                            id="SvgjsStop1103"
                            stop-opacity="0"
                            stop-color="rgba(137,225,203,0)"
                            offset="1"
                          ></stop>
                          <stop
                            id="SvgjsStop1104"
                        ...
                        <linearGradient id="SvgjsLinearGradient1110" x1="0" y1="0" x2="0" y2="1">
                          <stop
                            id="SvgjsStop1111"
                            stop-opacity="0.55"
                            stop-color="rgba(60,80,224,0.55)"
                            offset="0"
                          ></stop>
                          <stop
                            id="SvgjsStop1112"
                            stop-opacity="0"
                            stop-color="rgba(158,168,240,0)"
                            offset="1"
                          ></stop>
                          <stop
                            id="SvgjsStop1113"
                      ...
                      <g id="SvgjsG1116" class="apexcharts-grid">
                        ...
                        <g id="SvgjsG1118" class="apexcharts-gridlines-vertical">
                          <line
                            id="SvgjsLine1120"
                            x1="0"
                            y1="0"
                          ...
                          <line
                            id="SvgjsLine1121"
                            x1="66.11834161931819"
                            y1="0"
                            x2="66.11834161931819"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1122"
                            x1="132.23668323863637"
                            y1="0"
                            x2="132.23668323863637"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1123"
                            x1="198.35502485795456"
                            y1="0"
                            x2="198.35502485795456"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1124"
                            x1="264.47336647727275"
                            y1="0"
                            x2="264.47336647727275"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1125"
                            x1="330.59170809659093"
                            y1="0"
                            x2="330.59170809659093"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1126"
                            x1="396.7100497159091"
                            y1="0"
                            x2="396.7100497159091"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1127"
                            x1="462.8283913352273"
                            y1="0"
                            x2="462.8283913352273"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1128"
                            x1="528.9467329545455"
                            y1="0"
                            x2="528.9467329545455"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1129"
                            x1="595.0650745738637"
                            y1="0"
                            x2="595.0650745738637"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                          ...
                          <line
                            id="SvgjsLine1131"
                            x1="727.3017578125002"
                            y1="0"
                            x2="727.3017578125002"
                            y2="132.348"
                            stroke="#e0e0e0"
                            stroke-dasharray="7"
                            stroke-linecap="butt"
                      ...
                      <g id="SvgjsG1097" class="apexcharts-area-series apexcharts-plot-series">
                        <g
                          id="SvgjsG1098"
                          class="apexcharts-series"
                          zIndex="0"
                        ...
                        >
                          <path
                            id="SvgjsPath1105"
                            d="M0 132.348L0 96.349344C5.869136237004425 90.85120804743288 44.55207750767423 31.215986050166435 66.11834161931819 34.41048000000001C87.68460573096215 37.60497394983358 110.67041912699241 112.74235405016644 132.23668323863637 115.93684800000001C153.80294735028033 119.13134194983358 177.3702815884421 58.70252343991936 198.35502485795453 53.997984C219.33976812746695 49.293444560080644 243.18751360502162 90.29600500262323 264.47336647727275 86.290896C285.75921934952385 82.28578699737677 308.55791104278944 29.46939752145707 330.5917080965909 29.116559999999993C352.6255051503923 28.763722478542917 374.90682340485483 81.90388365358343 396.71004971590907 84.17332800000001C418.5132760269633 86.44277234641659 440.82421011762574 43.76166017297095 462.82839133522725 42.880752C484.83257255282876 41.99984382702905 509.05413328105266 72.34439625303798 528.9467329545455 78.87940800000001C548.8393326280384 85.41441974696204 573.868864372962 91.57737781542586 595.0650745738636 87.34968C616.2612847747653 83.12198218457415 639.5448696482048 48.93509638695855 661.1834161931818 51.880416C682.8219627381587 54.825735613041445 720.6391423562857 99.96108297410781 727.3017578125 105.34900800000001C727.3017578125 105.34900800000001 727.3017578125 132.348 727.3017578125 132.348C727.3017578125 132.348 0 132.348 0 132.348M0 96.349344C0 96.349344 0 96.349344 0 96.349344 "
                            fill="url(#SvgjsLinearGradient1101)"
                            fill-opacity="1"
                            stroke-opacity="1"
                            stroke-linecap="butt"
                            stroke-width="0"
                            ...
                            index="0"
                            clip-path="url(#gridRectMaskraj9uvxh)"
                                cy="0"
                                class="apexcharts-marker wpgmqy485h no-pointer-events"
                                stroke="#ffffff"
                                fill="#3c50e0"
                                fill-opacity="1"
                                stroke-width="2"
                        ...
                        <g id="SvgjsG1100" class="apexcharts-datalabels" data:realIndex="0"></g>
                        <g id="SvgjsG1109" class="apexcharts-datalabels" data:realIndex="1"></g>
                      </g>
                      <line
                        id="SvgjsLine1140"
                        x1="0"
                      ...
                      <g id="SvgjsG1142" class="apexcharts-xaxis" transform="translate(0, 0)">
                        ...
                        >
                          <text
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1146">Sep</tspan>
                            <title>Sep</title>
                          </text>
                          <text
                            id="SvgjsText1148"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1149">Oct</tspan>
                            <title>Oct</title>
                          </text>
                          <text
                            id="SvgjsText1151"
                            font-family="Satoshi, sans-serif"
                            x="132.23668323863637"
                            y="161.348"
                            text-anchor="middle"
                            dominant-baseline="auto"
                            font-size="12px"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1152">Nov</tspan>
                            <title>Nov</title>
                          </text>
                          <text
                            id="SvgjsText1154"
                            font-family="Satoshi, sans-serif"
                            x="198.35502485795456"
                            y="161.348"
                            text-anchor="middle"
                            dominant-baseline="auto"
                            font-size="12px"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1155">Dec</tspan>
                            <title>Dec</title>
                          </text>
                          <text
                            id="SvgjsText1157"
                            font-family="Satoshi, sans-serif"
                            x="264.47336647727275"
                            y="161.348"
                            text-anchor="middle"
                            dominant-baseline="auto"
                            font-size="12px"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1158">Jan</tspan>
                            <title>Jan</title>
                          </text>
                          <text
                            id="SvgjsText1160"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1161">Feb</tspan>
                            <title>Feb</title>
                          </text>
                          <text
                            id="SvgjsText1163"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1164">Mar</tspan>
                            <title>Mar</title>
                          </text>
                          <text
                            id="SvgjsText1166"
                            font-family="Satoshi, sans-serif"
                            x="462.82839133522737"
                            y="161.348"
                            text-anchor="middle"
                            dominant-baseline="auto"
                            font-size="12px"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1167">Apr</tspan>
                            <title>Apr</title>
                          </text>
                          <text
                            id="SvgjsText1169"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1170">May</tspan>
                            <title>May</title>
                          </text>
                          <text
                            id="SvgjsText1172"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1173">Jun</tspan>
                            <title>Jun</title>
                          </text>
                          <text
                            id="SvgjsText1175"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1176">Jul</tspan>
                            <title>Jul</title>
                          </text>
                          <text
                            id="SvgjsText1178"
                            ...
                            style="font-family: Satoshi, sans-serif"
                          >
                            <tspan id="SvgjsTspan1179">Aug</tspan>
                            <title>Aug</title>
                          </text>
                        </g>
                      </g>
                  ...
                  <div class="apexcharts-tooltip apexcharts-theme-light">
                    ...
                    <div class="apexcharts-tooltip-series-group" style="order: 1">
                      <span
                        class="apexcharts-tooltip-marker"
                        style="background-color: rgb(19, 194, 150)"
                      ></span>
                      <div
                        class="apexcharts-tooltip-text"
                        style="font-family: Satoshi, sans-serif; font-size: 12px"
      ...
      >
        ...
        <div class="px-6 pt-6 pb-7.5">
          <div class="mb-5.5 flex flex-wrap items-center gap-3.5">
            <button
              class="bg-primary/[0.08] text-primary border-primary inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary"
            >
              <span
                ><svg
                  width="18"
              ...
              Google</button
            ><button
              class="border-stroke dark:border-strokedark inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary"
            >
              <span
                ><svg
                  width="9"
          ...
          <div>
            <div
              class="grid gap-1 rounded bg-gray-2 py-2 px-4.5 dark:bg-graydark xsm:grid-cols-7 sm:grid-cols-5"
            >
              <div class="xsm:col-span-3">
                <h4 class="text-sm font-medium uppercase">EMAIL TITLE</h4>
              </div>
              <div class="xsm:col-span-2 sm:col-span-1">
                <h4 class="text-sm font-medium uppercase">STATUS</h4>
              </div>
              <div class="xsm:col-span-2 sm:col-span-1">
                <h4 class="text-sm font-medium uppercase xsm:text-right">CONVERSION</h4>
              </div>
            </div>
            <div class="mt-4.5 flex flex-col gap-6">
              <div class="grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5">
                ...
                <div class="xsm:col-span-2 sm:col-span-1">
                  <span
                    class="inline-block rounded bg-meta-8/[0.08] py-1 px-2.5 text-sm font-medium text-meta-8"
                    >In Queue</span
                  >
                </div>
                <div class="xsm:col-span-2 xsm:text-right sm:col-span-1">
                  <span class="inline-block font-medium text-sm text-black dark:text-white"
                    >0%(0)</span
                  >
                </div>
              </div>
              <div class="grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5">
                ...
                <div class="xsm:col-span-2 sm:col-span-1">
                  <span
                    class="inline-block rounded bg-meta-3/[0.08] py-1 px-2.5 text-sm font-medium text-meta-3"
                    >Sent</span
                  >
                </div>
                <div class="xsm:col-span-2 xsm:text-right sm:col-span-1">
              ...
              <div class="grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5">
                ...
                <div class="xsm:col-span-2 sm:col-span-1">
                  <span
                    class="inline-block rounded bg-primary/[0.08] py-1 px-2.5 text-sm font-medium text-primary"
                    >In Draft</span
                  >
                </div>
                <div class="xsm:col-span-2 xsm:text-right sm:col-span-1">
      ...
      >
        ...
        >
          <div>
            <h2 class="text-title-md2 font-bold text-black dark:text-white">Feedback</h2>
          </div>
          <div class="relative">
            <button>
              <svg
        ...
        <div class="p-6">
          <div class="flex flex-col gap-7">
            <div class="relative z-1 flex gap-5.5">
              ...
              >
                <img src="/assets/user-14-0ENwA2CR.png" alt="User" />
              </div>
              <div>
                <p class="text-black dark:text-white">
                  <span class="font-medium">Timothy Smith</span> Commented on Cloud
                ...
                <p class="mt-2.5 text-black dark:text-white">
                  It's an Affiliate commissions SaaS application that allows you to track your
                  affiliate revenue.
                </p>
              </div>
              <span
            ...
            <div class="relative z-1 flex gap-5.5">
              <div
                class="h-16 w-full max-w-16 rounded-full border-[3px] border-stroke dark:border-strokedark"
              >
                <img src="/assets/user-15-bmYDdjf2.png" alt="User" />
              </div>
              <div>
                <p class="text-black dark:text-white">
                  <span class="font-medium">Nancy Martino</span> Commented on Cloud
            ...
            <div class="relative z-1 flex gap-5.5">
              <div
                class="h-16 w-full max-w-16 rounded-full border-[3px] border-stroke dark:border-strokedark"
              >
                <img src="/assets/user-16-nfPzXuc1.png" alt="User" />
              </div>
              <div>
                <p class="text-black dark:text-white">
                  <span class="font-medium">Michael Morris</span> Commented on Cloud
